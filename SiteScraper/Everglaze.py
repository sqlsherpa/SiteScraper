...
pageList = ['http://www.chinaglaze.com/EverGlaze%C2%AE/pageNum_0.html',
            'http://www.chinaglaze.com/EverGlaze%C2%AE/pageNum_1.html'
			]
...
dfc = df.assign(ImageLinker = "http://chinaglaze.com" + df.ColorImgLink + "," + "http://chinaglaze.com" + df.ColorImgLink.str.replace('dots','bottle') + ",,,,,,")
